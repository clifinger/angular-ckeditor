...
["change","input","blur","saveSnapshot","key","paste","selectionChange"].forEach(function(a){g.onCKEvent(a,function(){h.$setViewValue(g.instance.getData()||"")})});var c=!0;["dataReady"].forEach(function(a){g.onCKEvent(a,function(){
